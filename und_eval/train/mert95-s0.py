...
num_epochs = cfg.model.mert95_s0.num_epochs  # 设置训练轮数  
save_path = cfg.model.mert95_s0.save_path  # 指定模型保存路径  
device = cfg.model.mert95_s0.device
dataset_index = cfg.model.mert95_s0.dataset_index
loss_path = cfg.model.mert95_s0.loss_path
output_len = cfg.model.mert95_s0.output_len
dataset_pt = cfg.model.mert95_s0.dataset_pt
  
ds = VecDatasetSearch(path=dataset_index, output_len=output_len, dir_path=dataset_pt,replace=cfg.model.mert95_s0.dataset)  
data_loader = torch.utils.data.DataLoader(ds, batch_size=cfg.model.mert95_s0.batch_size, shuffle=True)
